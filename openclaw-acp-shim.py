#!/usr/bin/env python3
"""
openclaw-acp-shim.py — ACP ↔ OpenClaw bridge for Buzz
...
Usage:
    Set in your buzz-acp env:
        ...
        BUZZ_ACP_AGENT_ARGS=/path/to/openclaw-acp-shim.py
    Or mark executable and set:
        BUZZ_ACP_AGENT_COMMAND=/path/to/openclaw-acp-shim.py
...
Repo:    https://github.com/darrenjrobinson/openclaw-acp-buzz
License: Apache 2.0
"""
...
def _handle_initialize(req_id, params: dict) -> None:
    ...
    _respond(req_id, {
        ...
        "server_info": {"name": f"openclaw-acp-shim ({AGENT_NAME})", "version": "1.0.0"},
